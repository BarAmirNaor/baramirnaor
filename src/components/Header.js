     ...
     return (
         <div>
                 ...
                 <Toolbar>
                     <Grid container justify="space-between">
                         ...
                         <Grid item>
                             ...
                             <Button style={{color:"#010A60"}} >Resources</Button>
                             <Button style={{color:"#010A60"}}>Blog</Button>
                             <Button style={{color:"#010A60"}}>About us</Button>
                             <Button style={{color:"#010A60"}}>Sign in</Button>
                             <Button style={{color:"#010A60",background:"#7B3FF2",borderRadius:"50px"}}>Get Started</Button>
                         </Grid>
                     </Grid>
                 </Toolbar>
             </AppBar>
             ...
             <Grid container   justify="center"
                   alignItems="center">
                 <Grid item>
             <Typography style={{color:"#010A60"}} variant="h3" gutterBottom>
